describe('Display cdn data', () => {
  beforeEach(() => {
    ...
    cy.intercept('/test.com/v1/cdn/cache?start_date=2022-02-05&end_date=2022-02-06&subdomain=api.test.com', {
      fixture: 'cdn/cache.json'
    }).as('cache')

    cy.intercept('/test.com/v1/cdn/bytes?start_date=2022-02-05&end_date=2022-02-06&subdomain=api.test.com', {
